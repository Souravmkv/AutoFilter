...
PICS = (environ.get('PICS', 'https://graph.org/file/1278c710cadf1232f2802.jpg')).split() #SAMPLE PIC
...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1001886229187')
